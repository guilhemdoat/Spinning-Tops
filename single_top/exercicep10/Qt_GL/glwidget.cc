...
// ======================================================================
void GLWidget::initializeGL() //méthode d'initialisation que nous n'avons pas modifiée, comme les 3 méthodes suivantes
{
  vue.init();
...
void GLWidget::keyPressEvent(QKeyEvent* event)
{
  ...
  case Qt::Key_C:                  // repositionne la vue au dessus de la toupie
    vue.initializePosition();
    break;

  case Qt::Key_V:                 // repositionne la vue sur le coté de la toupie
      vue.vuedecote();
      break;
